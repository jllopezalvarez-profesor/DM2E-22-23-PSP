...
public class Lanzador {
	...
	public static void main(String[] args) {
		...
		// Creamos un semáforo para limitar el número de filósofos que comen a la vez
		Semaphore semaforoMesa = new Semaphore(NUM_FILOSOFOS - 1);
		...
		for (int i = 0; i < filosofos.length; i++) {
			...
			filosofos[i] = new Filosofo(i + 1, izquierdo, derecho, semaforoMesa);
