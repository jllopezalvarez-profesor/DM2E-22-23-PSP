...
public class HiloNoSincronizado1 extends Thread {
	...
	// Este método no está sincronizado, y por lo tanto no es "seguro" desde un
	// punto de vista multihilo
	...
	public HiloNoSincronizado1(String nombreHilo) {
		super(nombreHilo);
	}
